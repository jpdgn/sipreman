...
exports.getAllAkademik = function(req, res) {
	var query = ('SELECT * FROM akademik');
...
exports.getAkademikById = function(req, res) {
	var sql = ('SELECT * FROM ?? WHERE kode = ?');
	var insert = ["akademik", req.params.id];
...
exports.createAkademik = function(req, res) {
	var data = req.body
